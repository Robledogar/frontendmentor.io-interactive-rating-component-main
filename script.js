...
function cargarDivPrincipal() {
  ...
  `
    ...
    divAtribucion.innerHTML = `
        <div class="attribution">
            ...
            Coded by <a href="https://www.linkedin.com/in/jose-luis-robledo-587062146/">robledogar</a>.
        </div>`
  ...
  divsValoracion.forEach((div) => {
    div.addEventListener("click", function() {
        divsValoracion.forEach((otroDiv) => {
            otroDiv.classList.remove('divMarcado');
          });
    ...
    function borrarDivPrincipal() {
        divAtribucion.remove();
        contenedorPrincipal.remove();
    }

    function cargarDivSecundario() {
        const contenedorSecundario = document.createElement('DIV');
        contenedorSecundario.classList.add('contenedorPrincipal', 'contenedorSecundario');
        ...
        <div class="contenedorValoracionFinal">
            <p class="valoracionFinal">You selected ${valorDelDivPulsado} out of 5</p>
        </div>
        <div class="contenedorTextosAgradecimiento">
        <h1 class="tituloAgradecimiento">Thank you!</h1>
        <p class="parrafoAgradecimiento">We appreciate you taking the time to give a rating. If you ever need more support, 
        ...
        document.body.appendChild(contenedorSecundario);
        document.body.appendChild(divAtribucion);
    }
